  ...
  n = {
    ...
    ["<leader>td"] = {
      function()
        ...
        utils.toggle_term_cmd "bpytop"
      end, desc = "ToggleTerm bpytop"
    },
    ...
    -- ["<F12>"] = { ":ToggleTerm<cr>", desc = "Toggle terminal" },
    ["<leader>;"] = { ":ToggleTerm size=30 direction=horizontal<cr>", desc = "Toggle terminal" },
