-- Command to check if you have the required dependencies to use YVim.
--
-- DESCRIPTION:
-- On neovim you can run
-- :healthcheck base
-- to know possible causes in case YVim is not working correctly.
...
function M.check()
  ...
  health.info(
    "YVim Version: " .. require("base.utils.updater").version(true)
  )
  health.info(
    "Neovim Version: v"
