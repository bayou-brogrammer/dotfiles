return function(_, opts)
  ...
  local C = require("kickstart.utils.status.env").fallback_colors
  local get_hlgroup = require("kickstart.utils").get_hlgroup
  local lualine_mode = require("kickstart.utils.status.hl").lualine_mode
  ...
  local function setup_colors()
    ...
    local colors = kickstart.user_opts("heirline.colors", {
      close_fg = Error.fg,
      fg = StatusLine.fg,
      bg = StatusLine.bg,
