return {
  ...
  event = "BufEnter",
  opts = function()
    local status = require "kickstart.utils.status"
    return {
      opts = {
        disable_winbar_cb = function(args)
          return not require("kickstart.utils.buffer").is_valid(args.buf)
      ...
      tabline = { -- bufferline
        ...
        { -- tab list
          ...
          { -- close button for current tab
            ...
            on_click = {
              callback = function() require("kickstart.utils.buffer").close_tab() end,
