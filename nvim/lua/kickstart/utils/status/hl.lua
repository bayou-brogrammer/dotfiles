--- ### KickstartNvim Status Highlighting
--
-- Statusline related highlighting utilities
--
-- This module can be loaded with `local hl = require "kickstart.utils.status.hl"`
--
-- @module kickstart.utils.status.hl
-- @copyright 2023
...
-- @usage local heirline_component = { provider = "Example Provider", hl = require("kickstart.utils.status").hl.mode },
...
-- @usage local heirline_component = require("heirline.utils").surround({ "|", "|" }, require("kickstart.utils.status").hl.mode_bg, heirline_component),
...
-- @usage local heirline_component = { provider = require("kickstart.utils.status").provider.fileicon(), hl = require("kickstart.utils.status").hl.filetype_color },
...
-- @usage local heirline_component = { provider = "Example Provider", hl = require("kickstart.utils.status").hl.get_attributes("treesitter") },
...
-- @usage local heirline_component = { provider = "Example Provider", hl = require("kickstart.utils.status").hl.file_icon("winbar") },
