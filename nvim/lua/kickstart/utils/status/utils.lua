--- ### KickstartNvim Status Utilities
--
-- Statusline related uitility functions
--
-- This module can be loaded with `local status_utils = require "kickstart.utils.status.utils"`
--
-- @module kickstart.utils.status.utils
-- @copyright 2023
...
-- @usage local string = require("kickstart.utils.status").utils.stylize("Hello", { padding = { left = 1, right = 1 }, icon = { kind = "String" } })
...
-- @usage local heirline_component = { on_click = { callback = function(...) local args = require("kickstart.utils.status").utils.statuscolumn_clickargs(...) end } }
