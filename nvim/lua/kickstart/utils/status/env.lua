--- ### KickstartNvim Status Environment
--
-- Statusline related environment variables shared between components/providers/etc.
--
-- This module can be loaded with `local env = require "kickstart.utils.status.env"`
--
-- @module kickstart.utils.status.env
-- @copyright 2023
...
M.separators = kickstart.user_opts("heirline.separators", {
  none = { "", "" },
  left = { "", "  " },
  right = { "  ", "" },
  center = { "  ", "  " },
...
M.attributes = kickstart.user_opts("heirline.attributes", {
...
M.icon_highlights = kickstart.user_opts("heirline.icon_highlights", {
  file_icon = {
...
M.sign_handlers = kickstart.user_opts("heirline.sign_handlers", M.sign_handlers)
