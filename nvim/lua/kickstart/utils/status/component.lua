--- ### KickstartNvim Status Components
--
-- Statusline related component functions to use with Heirline
--
-- This module can be loaded with `local component = require "kickstart.utils.status.component"`
--
-- @module kickstart.utils.status.component
-- @copyright 2023
...
local hl = require "kickstart.utils.status.hl"
local init = require "kickstart.utils.status.init"
local provider = require "kickstart.utils.status.provider"
local status_utils = require "kickstart.utils.status.utils"

local utils = require "kickstart.utils"
local buffer_utils = require "kickstart.utils.buffer"
...
-- @usage local heirline_component = require("kickstart.utils.status").component.fill()
...
---@return table # The Heirline component table
-- @usage local heirline_component = require("kickstart.utils.status").component.file_info()
...
---@param opts? table options for configuring file_icon, filename, filetype, file_modified, file_read_only, and the overall padding
---@return table # The Heirline component table
-- @usage local heirline_component = require("kickstart.utils.status").component.tabline_file_info()
...
---@return table # The Heirline component table
-- @usage local heirline_component = require("kickstart.utils.status").component.nav()
function M.nav(opts)
  opts = extend_tbl({
    ruler = {},
...
---@return table # The Heirline component table
-- @usage local heirline_component = require("kickstart.utils.status").component.cmd_info()
...
---@return table # The Heirline component table
-- @usage local heirline_component = require("kickstart.utils.status").component.mode { mode_text = true }
...
---@return table # The Heirline component table
-- @usage local heirline_component = require("kickstart.utils.status").component.breadcumbs()
...
---@return table # The Heirline component table
-- @usage local heirline_component = require("kickstart.utils.status").component.separated_path()
...
---@return table # The Heirline component table
-- @usage local heirline_component = require("kickstart.utils.status").component.git_branch()
...
---@return table # The Heirline component table
-- @usage local heirline_component = require("kickstart.utils.status").component.git_diff()
...
---@return table # The Heirline component table
-- @usage local heirline_component = require("kickstart.utils.status").component.diagnostics()
...
---@param opts? table options for configuring diagnostic providers and the overall padding
---@return table # The Heirline component table
-- @usage local heirline_component = require("kickstart.utils.status").component.treesitter()
...
---@return table # The Heirline component table
-- @usage local heirline_component = require("kickstart.utils.status").component.lsp()
function M.lsp(opts)
  opts = extend_tbl({
    lsp_progress = {
      str = "",
...
---@return table # The Heirline component table
-- @usage local heirline_component = require("kickstart.utils.status").component.foldcolumn()
...
---@return table # The Heirline component table
-- @usage local heirline_component = require("kickstart.utils.status").component.numbercolumn()
...
---@return table # The Heirline component table
-- @usage local heirline_component = require("kickstart.utils.status").component.signcolumn()
...
--- A general function to build a section of kickstart status providers with highlights, conditions, and section surrounding
---@param opts? table a list of components to build into a section
---@return table # The Heirline component table
-- @usage local heirline_component = require("kickstart.utils.status").components.builder({ { provider = "file_icon", opts = { padding = { right = 1 } } }, { provider = "filename" } })
