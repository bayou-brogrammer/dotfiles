--- ### KickstartNvim Status Heirline Extensions
--
-- Statusline related heirline specific extensions
--
-- This module can be loaded with `local kickstart_heirline = require "kickstart.utils.status.heirline"`
--
-- @module kickstart.utils.status.heirline
-- @copyright 2023
...
M.make_buflist = function(component)
  ...
  return require("heirline.utils").make_buflist(
    ...
    function() return vim.t.bufs end, -- use kickstart bufs variable
