--- ### Mason Utils
--
-- Mason related utility functions to use within KickstartNvim and user configurations.
--
-- This module can be loaded with `local mason_utils = require("kickstart.utils.mason")`
--
-- @module kickstart.utils.mason
-- @see kickstart.utils
-- @copyright 2022
  ...
  registry.update(vim.schedule_wrap(function(success, updated_registries)
    if success then
      ...
      if no_pkgs then
        ...
        kickstartevent "MasonUpdateCompleted"
      else
        local updated = false
