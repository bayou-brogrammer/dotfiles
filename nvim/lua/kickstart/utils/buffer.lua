...
--
-- This module can be loaded with `local buffer_utils = require "kickstart.utils.buffer"`
--
-- @module kickstart.utils.buffer
-- @copyright 2022
...
---@param compare_func string|function a string of a comparator defined in require("kickstart.utils.buffer").comparator or a custom comparator function
---@param skip_autocmd boolean|nil whether or not to skip triggering KickstartBufsUpdated autocmd event
...
local function unique_path(bufnr)
  return require("kickstart.utils.status.provider").unique_path() { bufnr = bufnr }
