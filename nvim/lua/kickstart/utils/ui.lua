--- ### KickstartNvim UI Options
--
--  Utility functions for easy UI toggles.
--
-- This module can be loaded with `local ui = require("kickstart.utils.ui")`
--
-- @module kickstart.utils.ui
-- @see kickstart.utils
-- @copyright 2022
...
local function ui_notify(silent, ...) return not silent and require("kickstart.utils").notify(...) end

--- Toggle notifications for UI toggles
---@param silent? boolean if true then don't sent a notification
function M.toggle_ui_notifications(silent) -- TODO: rename to toggle_notifications in KickstartNvim v4
...
function M.toggle_diagnostics(silent)
  ...
  vim.diagnostic.config(require("kickstart.utils.lsp").diagnostics[vim.g.diagnostics_mode])
...
-- TODO: remove old function name in KickstartNvim v4
...
function M.toggle_url_match(silent)
  ...
  require("kickstart.utils").set_url_match()
