...
vim.opt.shortmess:append({ W = true, I = true, c = true }) -- disable startup message

if vim.fn.has "nvim-0.9" == 1 then
  vim.opt.diffopt:append "linematch:60" -- enable linematch diff algorithm
end

local options = kickstart.user_opts("options", {
  opt = {
  ...
  g = {
    ...
    -- KickstartNvim specific global options
    ...
    ui_notifications_enabled = true,                                    -- disable notifications (TODO: rename to  notifications_enabled in KickstartNvim v4)
