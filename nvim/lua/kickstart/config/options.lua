...
opt.shortmess:append({ W = true, I = true, c = true }) -- disable startup message
...
local options = {
  ...
  g = {
    ...
    -- BaseNvim specific global options
    ...
    ui_notifications_enabled = true,                                    -- disable notifications (TODO: rename to  notifications_enabled in BaseNvim v4)
